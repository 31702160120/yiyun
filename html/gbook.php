...
<div class="tem_banner relative">
  <ul class="slides" style="height:380px;">
    <li style="background:url(../images/about.jpg) no-repeat center center; height:380px;"></li>
  </ul>
</div>
<section class="met_section  ">
    ...
    <section class="met_aside">
      ...
      <div class="met_aside_list">
        ...
        <dl class="list-none navnow">
          <dt><a href="gbook.php"  title="在线留言" class="zm"><span>在线留言</span></a></dt>
        </dl>
  ...
  <article>
    <div class="met_article">
      <div id="messagelist">
        <form enctype="multipart/form-data" method="POST" class="ui-from" name="myform" action="">
          <div class="v52fmbx">
            ...
            <dl>
              ...
              <dd class="ftype_input">
                <div class="fbox">
                  <input name="username" type="text" placeholder="姓名" data-required=1 />
                </div>
            ...
            <dl class="noborder">
              <dt>&nbsp;</dt>
              <dd>
                <input type="submit" name="Submit" value="提交信息" id="btn_save" style="margin: 0 20px;" class="submit" />
              </dd>
            </dl>
          </div>
        </form>
