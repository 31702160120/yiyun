...
<style type="text/css">
	...
	#nli{
		float: left;margin:-24px 40px 0 40px;
	}
	#nimg{
		width: 300px !important;height: 200px !important;float: left !important;
	}
	#np{
...
?>
<link media="screen" href="../css/all.css" type="text/css" rel="stylesheet" />
    ...
    <div id="small_img">
      <div class="maxwidth">
        <div id="small_imgs"> 
          ...
          <div title="" class="img" b="<?php echo $chr_rows['homeurl'];?>" l="" theid="69"> <img src="<?php echo $chr_rows['homeurl'];?>" alt=""/> </div>
          </a> 
