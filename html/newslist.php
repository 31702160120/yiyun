  ...
  <article>
    <div class="met_article">
      <section class="met_article_head">
        ...
        <div class="met_position"> <a href="index.php" title="首页">首页</a> &gt; <?php echo $chr_rows['ColumnName'];?></div>
      </section>
        ...
        <div class="">
          <div class="my_news" >
            ...
            while($rows=mysqli_fetch_array($result)){  ?>  
            	  <li>
                <h2> <a href="news.php?id=<?php echo $rows['NewsID']?>" title="<?php echo $rows['NewsTitle']?>" target="_black"><?php echo $rows['NewsTitle']?></a> </h2>
                <div class="article_info cl">
                	 <?php echo date('Y-m-d',$rows['PublishTime']);?>
                  <p> <a class="reader" href="news.php?id=<?php echo $rows['NewsID']?>" target="_black"> <b>看</b> <?php echo $rows['clicked'];?> </a> </p>
                </div>
                <div class="article">
                  <div class="article_img"> <a href="news.php?id=<?php echo $rows['NewsID']?>" title="" target="_black"><img src="<?php echo $rows['ImagesUrl']?>" alt=""></a> </div>
                  <P><?php echo $rows['NewsBrief'];?></p>
                </div>
                <div class="readmore"><a href="news.php?id=<?php echo $rows['NewsID']?>" target="_black">阅读全文<b></b></a></div>
              </li>
            	<?php }?>    
            </ul>
            ...
            <div class="met_pager">
            	...
            	<?php
    				...
    				?>
        		<a href="<?=$href['first']?>" class="NextA">首页</a>
        		<a href="<?=$href['prev']?>" class="NextA">上一页</a>
        		<a href="<?=$href['next']?>" class="NextA">下一页</a>
        		<a href="<?=$href['end']?>" class="NextA">尾页</a>
        </div>
      </div>
    </div>
  </article>
