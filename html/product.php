...
<div class="met_section met_section_asidenone met_section_sehed">
  	<div class="met_section_head"> <a href="index.php" title="首页">首页</a>
  	 &gt; <a href="productlist.php?id=<?php echo $ColumnID;?>"><?php echo $chr_rows['ColumnName'];?></a> 
  ...
  <div>
    <div class="met_article">
      ...
      <div style="text-align:center;">
        ...
        <p><img src="<?php echo $rows['ProductUrl']?>" alt="" style="height: 300px; width: 500px; max-width:660px; margin:20px;" /></p>
      </div>
        <div class="met_clear"></div>
        <ol class="met_nav">
          ...
          <ul class="met_page">
          	<?php 
          		if($maxID != $ProductID){
          			...
          			echo 
					'<li class="met_page_preinfo"><span>上一条</span><a href="product.php?id='.$Last_rows['Last'].'" target="_self">'.$top_rows['ProductName'].'</a></li>';
          		}
          		?>
          		...
          		<?php 
          			if($minID != $ProductID){
						...
						echo 
						'<li class="met_page_next"><span>下一条</span><a href="product.php?id='.$Next_rows['Next'].'" target="_self">'.$xia_rows['ProductName'].'</a></li>';
          			}
				?>        
