...
<div class="met_module3_list my_produc mysection">
  <h2><strong><?php echo $chr_rows['ColumnName'];?></strong><a href="#all" id="all" target="_black"></a></h2>
  <div class="my_produc_list">
    <div class="my_produc_list_s">
      <ul class="cl">
    	...
    	?>
        <li class="cright"> <a href="product.php?id=<?php echo $rows['ProductID'];?>" title="" target="_black">
          <div class="figure"> <img src="<?php echo $rows['ProductUrl'];?>" style="260px; height:260px;" alt="图片关键词"/> </div>
