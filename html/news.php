...
<title>产品内容</title>
<meta name="description" content="简洁大方的互联网公司企业白色HTML模板由ASPCMS模板仿站教程网站制作，大家可以免费下载使用，ASPCMS模板仿站教程网保证代码完全免费，使大家能够拥有一个喜欢的网络平台。" />
...
<div class="met_section met_section_asidenone met_section_sehed">
  	<div class="met_section_head"> <a href="index.php" title="首页">首页</a>
  	 &gt; <a href="newslist.php?id=<?php echo $ColumnID;?>"><?php echo $chr_rows['ColumnName'];?></a> 
  ...
  <div>
    <div class="met_article">
      ...
      <div style="text-align:center;">
        ...
        <p><span>作者：<?php echo $rows['Penster'];?></span>
        	<span>发布时间：<?php echo date('Y-m-d',$rows['PublishTime']);?></span>
        	<span>看:<?php echo $rows['clicked'];?></span></p>
        <p><img src="<?php echo $rows['ImagesUrl']?>" alt="" style="height: 300px; width: 500px; max-width:660px; margin:20px;" /></p>
      </div>
        <div class="met_clear"></div>
        <ol class="met_nav">
          ...
          <ul class="met_page">
          	<?php 
          		if($maxID != $NeswID){
          			...
          			echo 
					'<li class="met_page_preinfo"><span>上一条</span><a href="news.php?id='.$Last_rows['Last'].'" target="_self">'.$top_rows['NewsTitle'].'</a></li>';
          		}
          		?>
          		...
          		<?php 
          			if($minID != $NeswID){
						...
						echo 
						'<li class="met_page_next"><span>下一条</span><a href="news.php?id='.$Next_rows['Next'].'" target="_self">'.$xia_rows['NewsTitle'].'</a></li>';
          			}
				?>           	
          </ul>
        </div>
