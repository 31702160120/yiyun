...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 添加栏目</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="" enctype="multipart/form-data">      
      <div class="form-group">
        ...
        <div class="field">
        	<input name="ColumnName" type="text" class="input w50" value="" data-validate="required:请输入栏目名称" />
