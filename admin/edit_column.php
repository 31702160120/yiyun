  ...
  <div class="body-content">
    <form method="post" class="form-x" action="" enctype="multipart/form-data">      
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="ColumnName" value="<?=$ColumnName?>" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
        	<input readonly="readonly" type="text" class="input tips" style="width:25%; float:left;" value="<?=$oldurl?>" />
          	&nbsp;&nbsp;
      ...
      <div class="form-group">
        ...
        <div class="field" style="height: 34px;line-height: 34px;">
          <select id="Cotype" name="Cotype" style="width: 150px;" class="input w50">
