...
<div class="panel admin-panel">
  <div class="panel-head"><strong class="icon-reorder"> 首页轮播图列表</strong></div>
  <div class="padding border-bottom">  
  <a class="button border-yellow" href="add_pic.php" target="right"><span class="icon-plus-square-o"></span> 添加首页轮播图</a>
  </div> 
