  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">  
      <div class="form-group">
        ...
        <div class="field">
          <input name="username" type="text" class="input w50" value="" data-validate="required:请输入用户名" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input name="password" type="password" class="input w50" value="" data-validate="required:请输入密码" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group" style="line-height: 34px;">
        ...
        <div class="field">
        	<input type="radio" name="sex" value="0" checked="checked"/><label for="sex">男</label>
        	<input type="radio" name="sex" value="1"/><label for="sex">女</label>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button name="btn_add" class="button bg-main icon-check-square-o" type="submit"> 添加</button>
