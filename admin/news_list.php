  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="add_new.php?id=<?=$id; ?>"> 添加新闻</a> </li>
      </ul>
    </div>
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
        <!--<tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="test" value="0" />
           1</td>
          <td width="10%">我是标题我是标题我是标题我是标题</td>
          <td>2018-12-05 12:25:50</td>
          <td><font color="#00CC99">admin</font></td>
          <td>0</td>
          <td><div class="button-group"><a class="button border-main" href="add.html"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
				...
				?>
   			<!--<tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="test" value="1" />
           1</td>
          <td width="10%"><img src="images/11.jpg" alt="" width="70" height="50" /></td>
          <td>2018-12-05 12:25:50</td>
          <td><font color="#00CC99">admin001</font></td>
          <td>2016-07-01</td>
