...
<div class="header bg-main">
  ...
  <div class="head-l">
  	<a class="button button-little bg-green" href="../html/index.php" target="_blank">
  		<span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
  	<a href="pass.php" class="button button-little bg-blue" target="right">
  		<span class="icon-wrench"></span> 修改密码</a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="gl_user.php" target="right"><span class="icon-caret-right"></span>用户管理</a></li>
    <li><a href="pass.php" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
  </ul>   
  <h2><span class="icon-pencil-square-o"></span>栏目管理</h2>
  <ul>
  	<li><a href="home_img.php" target="right"><span class="icon-caret-right"></span>轮播图管理</a></li>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="huanyin.html" name="right" width="100%" height="100%"></iframe>
</div>
</body>
</html>