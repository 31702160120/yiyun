  ...
  <div class="body-content">
    <form method="post" class="form-x" action="" enctype="multipart/form-data">      
      <div class="form-group">
        ...
        <div class="field">
        	<input name="title" type="text" class="input" value="" data-validate="required:请输入新闻标题" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="penster" value="<?php if(!session_id())session_start();echo $_SESSION['username'];?>" />
          <div style="height: 42px;line-height: 42px;display: inline-block;color: #999;">
          	&nbsp;&nbsp;默认后台登录账号
          </div>
        </div>
      </div>
